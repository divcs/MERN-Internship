        ...
        {/* <header className='relative w-full border-b bg-white pb-4'>
          <div className='mx-auto flex max-w-7xl items-center justify-between px-4 py-2'>
            <div className='inline-flex items-center space-x-2'>
              ...
              <span classNameName='font-bold'>DevUI</span>
            </div>
          ...
          <div className='mx-auto max-w-7xl py-12 md:py-24'>
            <div className='grid items-center justify-items-center gap-x-4 gap-y-10 lg:grid-cols-2'>
              ...
              <img
                ...
                src='https://images.unsplash.com/photo-1701657129814-659814b0acfc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxNHx8fGVufDB8fHx8fA%3D%3D'
              />
            </div>
          </div>
        </div>
